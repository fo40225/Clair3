...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Example script with a boolean argument --native')

    # Add the --native argument with default=False
    parser.add_argument('--native', action='store_true', default=False, help='Use native mode')

    # Parse the command-line arguments
    args = parser.parse_args()

    # Access the value of --native
    native_mode = args.native

    # Your script logic goes here
    print(f'Native mode: {native_mode}')
